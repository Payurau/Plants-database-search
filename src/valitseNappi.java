...
public class valitseNappi extends JDialog {
	...
	public static void main(String[] args) {
		try {
			valitseNappi dialog = new valitseNappi();
	...
	public valitseNappi() {
		...
		lblPlantAddedTo = new JLabel("Choose what to edit!");
		lblPlantAddedTo.setFont(new Font("Baskerville Old Face", Font.PLAIN, 22));
		lblPlantAddedTo.setBounds(49, 10, 248, 58);
